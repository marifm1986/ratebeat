...
const HomeAffordabilityCalculator: React.FC = () => {
    // Form state
    const [annualIncome, setAnnualIncome] = useState<number>(700000)
    const [availableFunds, setAvailableFunds] = useState<number>(150000)
    const [monthlyDebt, setMonthlyDebt] = useState<number>(1250)
    const [creditScore, setCreditScore] = useState<string>('720+')
    const [dtiRatio, setDtiRatio] = useState<number>(40) // Default to "Balanced"
                ...
                <div className="mb-8">
                    ...
                    <div className="relative mt-2">
                        ...
                        <input
                            ...
                            className="relative w-full h-2 bg-transparent appearance-none cursor-pointer z-10 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-black [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-black [&::-moz-range-thumb]:cursor-pointer"
                        />
                    </div>
